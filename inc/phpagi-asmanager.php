<?php
  ...
  */
  class AGI_AsteriskManager
  {
    ...
    * Bridge
    *
    * @link http://www.voip-info.org/wiki-Asterisk+Manager+API+Action+Bridge
    * @param string $channel1
    * @param string $channel2
    * @param string $tone
    */
    function Bridge($channel1, $channel2, $tone)
    {
      return $this->send_request('Bridge', array('Channel1'=>$channel1, 'Channel2'=>$channel2, 'Tone'=>$tone));
    }
